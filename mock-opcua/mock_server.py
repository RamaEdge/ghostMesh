#!/usr/bin/env python3
"""
GhostMesh Mock OPC UA Server
Simulates industrial equipment for development and testing
"""
...
class MockOPCUAServer:
    ...
    def setup_logging(self):
        ...
        logging.basicConfig(
            ...
            handlers=[
                ...
                logging.FileHandler('mock_opcua_server.log')
            ]
        )
    ...
    async def create_server(self):
        ...
        # Set server name
        self.server.set_server_name("GhostMesh Mock OPC UA Server")
    ...
    async def setup_authentication(self):
        ...
        self.server.add_user("edge", "edgepass")
    ...
    async def run(self):
        """Main server loop"""
        self.logger.info("Starting GhostMesh Mock OPC UA Server")
    ...
    async def shutdown(self):
        """Graceful shutdown"""
        self.logger.info("Shutting down mock OPC UA server...")
        self.running = False
        ...
        self.logger.info("Mock OPC UA server shutdown complete")
